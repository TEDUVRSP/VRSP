 ...
 public class HandAnim : MonoBehaviour
{
  ...
  [SerializeField] private InputActionProperty IndexTouch;
  [SerializeField] private InputActionProperty ThumbTouch;
    ...
    void Update()
    {
      var gripTarget = controller.selectActionValue.action.ReadValue<float>();
      if (gripTarget >= 0){
      ...
      var triggerTarget = controller.activateActionValue.action.ReadValue<float>();
      if (triggerTarget >= 0){
      ...
      var triggerCapTarget = IndexTouch.action.ReadValue<float>();
      if (triggerCapTarget >= 0){
      ...
      var thumbCapTarget = ThumbTouch.action.ReadValue<float>();
      if (thumbCapTarget >= 0){
